      ...
      <div className={"mx-auto w-1/2 items-center justify-center"}>
        <form className="flex items-center justify-between rounded-lg border border-border-light-primary-color px-4 text-center dark:border-gray-700 xs:text-[1rem] md:text-lg">
          <input
            ...
            className="overflow-x-scroll rounded-xl bg-transparent py-3 font-poppins text-amber-700 focus:outline-hidden dark:text-pink-500 xs:text-xs xs:placeholder:text-xs md:w-3/4 md:text-base md:placeholder:text-base"
            value={searchQuery}
